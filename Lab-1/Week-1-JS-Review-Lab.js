...
//WRITE YOUR CODE BELOW
console.log(
  `This house is at ${listing1.address} is owned by ${listing1.currentOwner}`
);
/**
 * NOTE: THIS TASK IS TRICKY!
 * Task-4: Create a function to calculate the realtor fees.z
...
function realtorFees(listing) {
  ...
  realtorFee = price <= 450000 ? price * 0.025 : price * 0.02;
  return realtorFee;
}
...
const listingAscendingly = listings.sort(
  (studA, studB) =>
    studA.price.replace(/[$,]/g, "") - studB.price.replace(/[$,]/g, "")
);
